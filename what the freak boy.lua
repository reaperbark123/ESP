...
local SaveManager = {} do
	...
	function SaveManager:Load(name)
		...
		if not isfile(name) then return false, 'invalid file' end
	...
	function SaveManager:LoadAutoloadConfig(filename)
		if isfile(filename) then
            --SaveManager:Save(filename)
			local success, err = self:Load(filename)
			if not success then
				return self.Library:Notify("Failed to load settings " .. err)
			end
		end
